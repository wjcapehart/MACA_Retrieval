...
if [ "$unamestr" == 'Darwin' ] || [ "$hostname" == 'sundog.ias.sdsmt.edu' ]; then
   ...
   export     FUTURE_ORIGINAL_URL="https://cida.usgs.gov/thredds/dodsC/macav2metdata_monthly_future"
   export HISTORICAL_ORIGINAL_URL="https://cida.usgs.gov/thredds/dodsC/macav2metdata_monthly_historical"

   # Setting Local Points to Revieved Clipped Data

   export CLIPPED_PREFIX="/projects/ECEP/LOCA_MACA_Ensembles/MACA/MACA_OUTPUT/grid_monthly/NGP_MONTHLY_MACA"
